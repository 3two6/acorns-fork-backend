...
class JWTAuthenticationFilter:UsernamePasswordAuthenticationFilter() {
    ...
    private lateinit var authManager:AuthenticationManger
...
//                }
    ...
    override fun successfulAuthentication(
        ...
        val token = JwtUtil.createToken(authentication)
        res.addHeader(JwtUtil.authHeaderField, JwtUtil.PREFIX + token)
    }
